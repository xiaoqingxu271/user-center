...
public interface UserService extends IService<User> {
     ...
     * 管理员修改用户信息
     *
     * @param modifyUserDTO 管理员修改用户DTO
     * @return 操作结果
     */
    BaseResponse<String> modifyUser(ModifyUserDTO modifyUserDTO);

    /**
     * 管理员新增用户
     *
     * @param addUserDTO 新增用户DTO
     * @return 操作结果
     */
    BaseResponse<String> addUser(AddUserDTO addUserDTO);
}
